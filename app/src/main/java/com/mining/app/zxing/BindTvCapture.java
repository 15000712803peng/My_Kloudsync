 ...
 * @author Ryan.Tang
 */
public class BindTvCapture extends MipcaActivityCapture implements Callback, TextureView.SurfaceTextureListener {
...
//            surfaceView.SetHorization(isHorization);
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            Toast.makeText(BindTvCapture.this, getResources().getString(R.string.Scan_failed), Toast.LENGTH_SHORT).show();
        } else {
