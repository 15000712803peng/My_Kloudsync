...
//                    meetingKit.prepareStart(MeetingViewActivity.this, meetingConfig, meetingConfig.getLessionId() + "");
//                } else {
//                    MeetingKit.getInstance().prepareJoin(MeetingViewActivity.this, meetingConfig);
//                }
//            }
//        });
...
//                        new CenterToast.Builder(MeetingViewActivity.this).setSuccess(true).setMessage(getString(R.string.operate_success)).create().show();
//                    } else {
//                        new CenterToast.Builder(MeetingViewActivity.this).setSuccess(false).setMessage(getString(R.string.operate_failure)).create().show();
//
//                    }
//                } else {
//                    new CenterToast.Builder(MeetingViewActivity.this).setSuccess(false).setMessage(getString(R.string.operate_failure)).create().show();
...
//        yinxiangCreatePopup.getPopwindow(MeetingViewActivity.this);
...
//                soundtrackRecordManager = SoundtrackRecordManager.getManager(MeetingViewActivity.this);
