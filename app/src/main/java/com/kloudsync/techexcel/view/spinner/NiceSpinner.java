...
//                }
        ...
        if (entries != null) {
            attachDataSource(Arrays.asList(entries), this.spinnerTextFormatter);
        }
...
//                throw new IllegalArgumentException("Position must be lower than adapter count!");
    ...
    public <T> void attachDataSource(@NonNull List<T> list, SpinnerTextFormatter spinnerTextFormatter) {
    ...
    public void setAdapter(ListAdapter adapter, SpinnerTextFormatter spinnerTextFormatter) {
        this.spinnerTextFormatter = spinnerTextFormatter;
        this.selectedTextFormatter = spinnerTextFormatter;
