...
public class CountryCodeShow {
	...
	static {
		...
		ccl.add(new CountryCodeInfo(213, "Algeria", "A"));
		ccl.add(new CountryCodeInfo(244, "Angola", "A"));
		ccl.add(new CountryCodeInfo(54, "Argentina", "A"));
		ccl.add(new CountryCodeInfo(61, "Australia", "A"));
		ccl.add(new CountryCodeInfo(43, "Austria", "A"));
		ccl.add(new CountryCodeInfo(994, "Azerbaijan", "A"));
		ccl.add(new CountryCodeInfo(93, "Afghanistan", "A"));
		ccl.add(new CountryCodeInfo(355, "Albania", "A"));
		ccl.add(new CountryCodeInfo(374, "Armenia", "A"));
		...
		ccl.add(new CountryCodeInfo(359, "Bulgaria", "B"));
		...
		ccl.add(new CountryCodeInfo(506, "Costa Rica", "C"));
		...
		ccl.add(new CountryCodeInfo(855, "Cambodia", "C"));
		ccl.add(new CountryCodeInfo(237, "Cameroon", "C"));
		ccl.add(new CountryCodeInfo(235, "Chad", "C"));
		ccl.add(new CountryCodeInfo(357, "Cyprus", "C"));

		ccl.add(new CountryCodeInfo(1809, "Dominican Republic", "D"));

		ccl.add(new CountryCodeInfo(593, "Ecuador", "E"));
		ccl.add(new CountryCodeInfo(20, "Egypt", "E"));
		ccl.add(new CountryCodeInfo(251, "Ethiopia", "E"));
		ccl.add(new CountryCodeInfo(503, "El Salvador", "E"));
		ccl.add(new CountryCodeInfo(240, "Equatorial Guinea", "E"));
		ccl.add(new CountryCodeInfo(251, "Estonia", "E"));
		ccl.add(new CountryCodeInfo(670, "East Timor", "E"));

		ccl.add(new CountryCodeInfo(33, "France", "F"));
		ccl.add(new CountryCodeInfo(358, "Finland", "F"));

		ccl.add(new CountryCodeInfo(49, "Germany", "G"));
		ccl.add(new CountryCodeInfo(233, "Ghana", "G"));
		ccl.add(new CountryCodeInfo(30, "Greece", "G"));
		ccl.add(new CountryCodeInfo(502, "Guatemala", "G"));
		...
		ccl.add(new CountryCodeInfo(504, "Honduras", "H"));
		...
		ccl.add(new CountryCodeInfo(353, "Ireland", "I"));
		ccl.add(new CountryCodeInfo(972, "Israel", "I"));
		ccl.add(new CountryCodeInfo(225, "Ivory Coast", "I"));
		ccl.add(new CountryCodeInfo(354, "Iceland", "I"));
		...
		ccl.add(new CountryCodeInfo(218, "Libya", "L"));
		ccl.add(new CountryCodeInfo(352, "Luxembourg", "L"));
		ccl.add(new CountryCodeInfo(370, "Lithuania", "L"));
		ccl.add(new CountryCodeInfo(371, "Latvia", "L"));
		...
		ccl.add(new CountryCodeInfo(356, "Malta", "M"));
		...
		ccl.add(new CountryCodeInfo(850, "North Korea", "N"));
		...
		ccl.add(new CountryCodeInfo(227, "Niger", "N"));
		...
		ccl.add(new CountryCodeInfo(351, "Portugal", "P"));
		...
		ccl.add(new CountryCodeInfo(966, "Saudi Arabia", "S"));
		ccl.add(new CountryCodeInfo(82, "South Korea", "S"));
		ccl.add(new CountryCodeInfo(34, "Spain", "S"));
		ccl.add(new CountryCodeInfo(46, "Sweden", "S"));
		ccl.add(new CountryCodeInfo(41, "Switzerland", "S"));
		ccl.add(new CountryCodeInfo(65, "Singapore", "S"));
		ccl.add(new CountryCodeInfo(421, "Slovakia", "S"));
		ccl.add(new CountryCodeInfo(94, "Sri Lanka", "S"));
		ccl.add(new CountryCodeInfo(963, "Syria", "S"));
		ccl.add(new CountryCodeInfo(249, "Sudan", "S"));
		ccl.add(new CountryCodeInfo(381, "Serbia", "S"));
		ccl.add(new CountryCodeInfo(386, "Serbia", "S"));
		ccl.add(new CountryCodeInfo(221, "Senegal", "S"));

		ccl.add(new CountryCodeInfo(886, "Taiwan", "T"));
		ccl.add(new CountryCodeInfo(66, "Thailand", "T"));
		ccl.add(new CountryCodeInfo(90, "Turkey", "T"));
		ccl.add(new CountryCodeInfo(216, "Tunisia", "T"));
		...
		ccl.add(new CountryCodeInfo(971, "United Arab Emirates", "U"));
		ccl.add(new CountryCodeInfo(44, "United Kingdom", "U"));
		ccl.add(new CountryCodeInfo(1, "United States", "U"));
		ccl.add(new CountryCodeInfo(380, "Ukraine", "U"));
		ccl.add(new CountryCodeInfo(598, "Uruguay", "U"));
		ccl.add(new CountryCodeInfo(998, "Uzbekistan", "U"));
		ccl.add(new CountryCodeInfo(256, "Uganda", "U"));

		ccl.add(new CountryCodeInfo(58, "Venezuela", "V"));
		ccl.add(new CountryCodeInfo(84, "Vietnam", "V"));
