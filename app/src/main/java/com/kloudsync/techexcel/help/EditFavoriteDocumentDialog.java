...
public class EditFavoriteDocumentDialog {
    ...
    public void setPopEditDocumentListener(PopEditDocumentListener popEditDocumentListener) {
        EditFavoriteDocumentDialog.popEditDocumentListener = popEditDocumentListener;
    }
    ...
    public void initPopuptWindow() {
        ...
        et_title.setText(document.getTitle());
                ...
                try {
                    JSONObject responsedata = com.ub.techexcel.service.ConnectService.submitDataByJson(
                            AppConfig.URL_PUBLIC
                                    + "FavoriteAttachment/RenameAttachment?itemID=" + document.getItemID()
