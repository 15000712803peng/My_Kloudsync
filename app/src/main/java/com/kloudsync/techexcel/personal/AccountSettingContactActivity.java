...
public class AccountSettingContactActivity extends AppCompatActivity {
    ...
    private List<AccountSettingContactBean> aslist = new ArrayList<AccountSettingContactBean>();

    ArrayList<AccountSettingContactBean> eList = new ArrayList<AccountSettingContactBean>();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 0x00:
                    ...
                    asAdapter = new AccountSettingContactAdapter(AccountSettingContactActivity.this, aslist, true, 0);
    ...
    private List<AccountSettingContactBean> formatjson(JSONObject jsonObject) {
        ...
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before,
                ...
                for (int i = 0; i < aslist.size(); i++) {
                    AccountSettingContactBean cus = aslist.get(i);
