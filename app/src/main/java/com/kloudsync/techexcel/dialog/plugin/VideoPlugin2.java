 ...
 */
public class VideoPlugin2 implements IPluginModule {
    ...
    public void onClick(Fragment currentFragment, final RongExtension extension) {
        ...
        Intent intent = new Intent(RongVoIPIntent.RONG_INTENT_ACTION_VOIP_SINGLEVIDEO2);
...
//        intent.putExtra("targetId", targetId);
    ...
    private void SendSocketToUB(String targetId) {
        ...
        for (int i = 0; i < ConversationActivity.ulist.size(); i++) {
            cus = ConversationActivity.ulist.get(i);
