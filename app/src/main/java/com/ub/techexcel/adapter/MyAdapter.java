...
public class MyAdapter extends BaseAdapter {
    ...
    public MyAdapter(Context mContext, List<Customer> list) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            viewHolder.selectedImage = view.findViewById(R.id.img_selected);
        ...
        if (entity.isSelected()) {
            viewHolder.selectedImage.setImageResource(R.drawable.select_d);
        } else {
            viewHolder.selectedImage.setImageResource(R.drawable.unselect);
        }
