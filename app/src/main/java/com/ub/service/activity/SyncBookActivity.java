...
public class SyncBookActivity extends BaseActivity implements View.OnClickListener,
    ...
    private RelativeLayout prepareStart, syncdisplayoutline,syncdisplaynote, syncdisplaymembers, syncdisplaymeeting, syncdisplaychat, syncdisplayproperty, syncdisplayshare, syncyinxiang, syncdisplayquit, prepareScanTV;
...
//                openDocumentPopup();
    ...
    private void gotoOtherNoteList(String userid) {
        ...
        syncRoomOtherNoteListPopup.getPopwindow(SyncBookActivity.this);
...
//        String url = AppConfig.URL_PUBLIC + "DocumentNote/ItemByLocalFileID?localFileID=ab3a05cb-f813-4cb7-b029-e6faffcb5586";
    ...
    private void selectNoteBook(final int linkID, final JSONObject linkProperty) {
        if (linkID == 0) {
            ...
            selectNoteDialog = new SelectNoteDialog(SyncBookActivity.this, lessonId);
