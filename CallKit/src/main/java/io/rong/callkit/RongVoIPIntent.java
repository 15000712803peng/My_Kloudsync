...
public class RongVoIPIntent {
    ...
    public static final String RONG_INTENT_ACTION_VOIP_SINGLEAUDIO2 = "io.rong.intent.action.voip.SINGLEAUDIO2";
    public static final String RONG_INTENT_ACTION_VOIP_SINGLEVIDEO2 = "io.rong.intent.action.voip.SINGLEVIDEO2";
